...
module.exports = {
    Query: {
        // Step 18 - matches "launches" defined in schema.js
         // fieldName: (parent, args, context, info) => data
        // Uses launchAPI.getAllLaunches
        //launches: async (_, __, { dataSources}) =>dataSources.launchAPI.getAllLaunches(),
        launch: (_, {id}, {dataSources}) => dataSources.launchAPI.getLaunchById({ launchId: id}),
        me: async (_, __, { dataSources }) => dataSources.userAPI.findOrCreateUser(),
        // Step 21 - update launches for Pagination
...
// Step 27 - Mutations were first defined in the schema
  Mutation: {
          ...
          // Step 26 - takes in an email and returns a Token
